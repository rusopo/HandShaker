...
--rol varchar(255),
--salt varchar(255),
--valoracionMedia bigint not null,
...
INSERT into Usuario values(1,'admin','4e472a2779abd6d6571c76b0f845cb5d20e084e7', 34, 'admin@gmail.com',44.2, 44.3, 'Administrador','administrador','8d6ebca8c2f3bca1336d778fffcfc941',0);
INSERT into Usuario values(2,'rusopo','d16b254da3bab8814357b2566ba2bc988c266b21', 23, 'ruben@gmail.com',40.4312585, -3.7102769000000535, 'Ruben','usuario','008c483eb1bcc2d4c54babc9bc04cfd2',0);
INSERT into Usuario values(3,'test1','935b09d31e97ce2cd6222084b30a01cdff91c6bc', 33, 'test@gmail.com',40.4312585, -3.7102769000000535, 'Test','usuario','5795fce1d232e7ceaf777deeb8171600',0);
INSERT into Usuario values(4,'manuel','a29e7a225f6e9d55b1b009f296d4143c18d13018',32,'manuelfreire@gmail.com',40.452807689244956,-3.733441060852101,'Manuel Freire','usuario','b175386dabcdb205311112cda6bac27d',5);
...
INSERT INTO habilidadesUsuario VALUES(4,6);
...
INSERT INTO interesesUsuario VALUES(4,5);


----NEGOCIACION
--id bigint generated by default as identity (start with 1),
--aceptada bit not null,
--fechaAceptada varchar(255),
--usuario1_id bigint,
--usuario2_id bigint,
INSERT INTO Negociacion VALUES(1,false,NULL,4,2);
INSERT INTO Negociacion VALUES(2,false,NULL,4,2);
INSERT INTO Negociacion VALUES(3,false,NULL,2,4);
--
----OFERTA
--id bigint generated by default as identity (start with 1),
--negociacion_id bigint,
--servicioOfrecido_id bigint,
--servicioSolicitado_id bigint,
--usuarioEnvia_id bigint,
--usuarioRecibe_id bigint,

INSERT INTO Oferta VALUES(1,1,3,4,4,2);
INSERT INTO Oferta VALUES(2,2,6,5,4,2);
INSERT INTO Oferta VALUES(3,3,1,5,2,4);
...
--VALORACION
--id bigint generated by default as identity (start with 1),
--estaValorado bit not null,
--puntuacion bigint not null,
--usuarioQueValora_id bigint,
--usuarioValorado_id bigint,

INSERT INTO Valoracion VALUES(1,true,5,2,4);
